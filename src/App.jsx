...
// import CheckIn from "./pages/CheckIn";
// import Diet from "./pages/Diet";
// import Calories from "./pages/calories"; // <-- new
// import Admin from "./pages/Admin";
// import Login from "./pages/Login";
// import Profile from "./pages/Profile";
// import AdminProfile from "./pages/AdminProfile";
// import CheckInHistory from "./pages/CheckInHistory";
// import EditProfile from "./pages/EditProfile";
// import Diet from "./pages/diet_recommend"; // adjust path if needed
...
//           <Link to="/check-in" style={{ marginRight: "20px" }}>Check-In</Link>
//           <Link to="/diet" style={{ marginRight: "20px" }}>Diet Plan</Link>
//           <Link to="/calories" style={{ marginRight: "20px" }}>Calories</Link> {/* <-- added */}
//         </>
//       )}
...
//                   <Route path="/check-in" element={<CheckIn />} />
//                   <Route path="/diet" element={<Diet />} />
//                   <Link to="/diet_recommend" style={{ marginRight: "20px" }}>Diet Recommendation</Link> {/* ✅ new */}
//                   <Route path="/calories" element={<Calories />} /> {/* <-- added */}
//                   <Route path="/CheckInHistory" element={<CheckInHistory />} />
//                   <Route path="/EditProfile" element={<EditProfile />} />
//                 </>
//               )}
...
import CheckIn from "./pages/CheckIn";
import DietRecommend from "./pages/diet_recommend"; // ✅ Correct import
    ...
    >
      ...
      {role === "user" && (
        <>
          ...
          <Link to="/diet-recommend" style={{ marginRight: "20px" }}>Diet Recommendation</Link>
          
          <Link to="/calories" style={{ marginRight: "20px" }}>Calories</Link>
          {/* <Link to="/gymchatbot" style={{ marginRight: "20px" }}>Gym Chatbot</Link> */}
            ...
            <Routes location={location}>
              ...
              {role === "user" && (
                <>
                  ...
                  {/* <Route path="/gymchatbot" element={<GymChatbot />} />      */}
